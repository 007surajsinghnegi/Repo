...
-->
  ...
  <div class="grid-container fluid doctors">
    <div class="grid-x">
      ...
      ?>
        ...
        ?>
          <div class="cell large-offset-2 large-6 docdescription" style="    padding-bottom: 28px;">
            <div class="card">
              <div class="card-section">
                <div class="grid-x grid-padding-x" >
                  <div class="cell large-2 small-3">
                    <img src="images/download.png" alt="" id="img">
                  </div>
                  <div class="cell large-6 small-9">
                    <h4 id="name">Dr. Subhash Chandra</h4>
                    <b id = "hosp">BLK Super Speciality Hospital, Delhi</b>
                    <div class="grid-x" >
                      <div class="cell large-4 small-5 small-7">
                        <i class="fa fa-calendar-check-o" id="exp">33 years</i>
                      </div>
                      <div class="type auto" id="spec">
                        <img src="images/certification.svg" alt="" style="max-width: 8%;"> Cardiology
                      </div>
                    </div>
                  </div>-+
                <div class="grid-container fieldspecialist">
                  <div class="grid-x" style="margin-top:10px;">
                    ...
                    <div class="field large-2 small-6" style="    background: #E6E6E6;" >
                      Cardiac Ablation
                    </div>
                    <div class="field large-2 small-5" style="    background: #E6E6E6;" >
                      Electrophysiology
                    </div>
                    <div class="field large-3 small-6" style="    background: #E6E6E6;" >
    ...
    <div class="cell large-4 query">
      <div class="grid-x" style="justify-content: center;">
        <div class="card" style="margin-top: 0px!important;">
          <div class="card-section">
            <button type="button" class="button expanded primary" style="border-radius: 10px;">ree
 ...
 async function get(){
  ...
  function appendData(data){
    ...
    for (var i =0 ; i <data.length; i++){
      ...
      for(var k = 0; k < fellow.length; k++) {
            fellow[k].innerHTML = data[i].fellowship;
        }
    }
  }
  // const res = await fetch('http://3.22.84.131:8000/doctor/');
  ...
  // document.getElementById('hosp').innerHTML=jsonObj.hospital;
// }
</script>
